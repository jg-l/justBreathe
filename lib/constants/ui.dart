const appTitle = 'justBreathe';
const tagLine = 'Take time to breathe';

const durationSettingText = 'Duration';
const playSoundSettingText = 'Play Sounds';
const zenModeSettingText = 'Zen Mode';

const beginButtonText = 'Begin';
const endButtonText = 'End';
